...
Логика как в PROMOSTAFF PRO (Telegram): 24 ч без активности в сценарии; второе через 72 ч
только если уже был телефон в форме (заказ или анкета). Доставка — Platform API MAX.
"""
...
MSG_24H = (
    ...
    "Продолжите в любое время: откройте этот чат с ботом — мы подхватим с того же места в сценарии."
)
